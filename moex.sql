...
CREATE TABLE IF NOT EXISTS clientele(
	...
	CONSTRAINT clientele_stock_acc_fk FOREIGN KEY (stock_acc) REFERENCES brokerage_accounts(stock_acc),
	CONSTRAINT clientele_deriv_acc_fk FOREIGN KEY (deriv_acc) REFERENCES derivatives_accounts(deriv_acc),
	CONSTRAINT clientele_curr_acc_fk FOREIGN KEY (curr_acc) REFERENCES currency_accounts(curr_acc),
	CONSTRAINT clientele_ii_stock_acc_fk FOREIGN KEY (ii_stock_acc) REFERENCES brokerage_accounts(stock_acc),
	CONSTRAINT clientele_ii_deriv_acc_fk FOREIGN KEY (ii_deriv_acc) REFERENCES derivatives_accounts(deriv_acc),
	CONSTRAINT clientele_ii_curr_acc_fk FOREIGN KEY (ii_curr_acc) REFERENCES currency_accounts(curr_acc)
);
...
DROP TABLE derivatives_accounts;
